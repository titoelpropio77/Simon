    ...
    return (
        ...
        >
            ...
            <Tab eventKey="localizacion" title="Localización">
                <div className="card-body">{props.fields.secondSection}</div>
            </Tab>
            <Tab eventKey="confinaciadores" title="Confinaciadores"></Tab>
            <Tab eventKey="componentes" title="Componentes"></Tab>
            <Tab
