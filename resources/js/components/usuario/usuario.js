...
export default class Usuario extends Component {
    constructor(props) {
        ...
        this.state = {
            titleForm: "Usuario",
            urlDataTable: "getUsersDataTable",
            elementId: 0,
            statusModal: false,
            //fields
            optionsSelected: "",
    ...
    propertiesDataTable(elementId) {
        const columns = [
            ...
            },
            {
                data: "perfil",
                render: function(type, data, row) {
                    return row.perfil ? row.perfil.nombre : "Sin perfil";
                }
            },
            {
                data: "licencia",
                render: function(type, data, row) {
                    return row.licencia ? row.licencia.licRepLegal : "Sin Licencia";
                }
            },
...
ReactDOM.render(<Usuario />, document.getElementById("contentBody"));
