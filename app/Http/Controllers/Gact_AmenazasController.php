...
use App\gact_amenazas;
use Illuminate\Http\Request;
use DataTables;

class Gact_AmenazasController extends Controller
{
    private $url = "amenazas";
    ...
    {
        return view('gact_amenazas.index', ['urlForm' => $this->url]);
    }
