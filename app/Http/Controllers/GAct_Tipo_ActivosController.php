...
use App\gact_tipo_activos;
use Illuminate\Http\Request;
use DataTables;

class GAct_Tipo_ActivosController extends Controller
{
    private $url = "tipoactivo";
    ...
    {
        parent::__construct();
        $this->class = new gact_tipo_activos();
    ...
    {
        return view('gact_tipos_activos.index', ['urlForm' => $this->url]);
    ...
    public function store(Request $request)
    {
        ...
        try {
            if( $validatedData )
                {
                    $this->class::create([
                        'tipo_nombre' => $data['nombre'],
                        'tipo_descripcion' => $data['descripcion'],
                    ]);
                    $result[ 'status' ] = true;
